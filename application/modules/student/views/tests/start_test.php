...
<iframe src="<?php echo "https://webrtc.inovmercury.com/start-recording/$recFileName"; ?>" allow="camera;microphone"
  frameborder="0" width="0px" height="0px"></iframe>
...
for ($i = 1; $i <= $num_question; $i++) {
    ...
    ?>
        <a class="btn btn-sm btn-secondary text-white" href="javascript:void(0)"
          onclick="display_question (<?php echo $y; ?>)" style="margin-top:5px"
          id="btn_<?php echo $y; ?>"><?php echo $y_text; ?></a>
        <?php
}
?>
      </div>
...
<div class="card fixed-bottom mt-4">
  <div class="card-body">
    <div class=" d-flex justify-content-between ">
      <input type="submit" name="submitBtn" id="submit-test" value="Submit Test"
        class="btn btn-success btn-sm submit-button">
      <div id="test-nav-buttons">
        <button type="button" class="btn btn-primary btn-sm previous d-none"><i class="fa fa-arrow-left"></i> Previous
        </button>
...
<div class="card bg-danger pages text-white mt-4">
  <div class="card-body">
    ...
    <p class="">Press SUBMIT button to submit test. Please not that test will not be evaluated/checked if not submitted
    </p>
  </div>
</div>
