...
echo $this->session->userdata('site_title');?></title>
  ...
  <link rel="stylesheet"
    href="<?php echo base_url(THEME_PATH . 'assets/css/vendor/bootstrap-datepicker3.min.css'); ?>" />
...
<body id="app-container"
  class="menu-sub-hidden show-spinner <?php if (isset($right_sidebar)) {echo 'right-menu';} else {echo 'vertical boxed';}?> ">
  <?php
...
?>
  <nav class="navbar fixed-top">
    ...
    <div class="d-flex align-items-center navbar-left">
      ...
      <a class="btn btn-sm btn-outline-dark ml-3 "
        href="<?php echo site_url('coaching/indiatests/index/' . $coaching_id); ?>"><i
          class="iconsminds-clothing-store"></i> <span class="d-none d-md-inline-block">Free Content</span></a>
    </div>
    ...
    <div class="navbar-right">
      ...
      <div class="user d-inline-block">
        <button class="btn btn-empty p-0" type="button" data-toggle="dropdown" aria-haspopup="true"
          ...
          <span>
            <img alt="Profile Picture" src="<?php echo base_url($this->common_model->profile_image()); ?>"
        ...
        <div class="dropdown-menu dropdown-menu-right mt-3">
          <a class="dropdown-item py-0"
            href="<?php echo site_url('coaching/users/my_account/' . $coaching_id . '/' . $member_id); ?>">
            <div class="d-flex">
          ...
          <a class="dropdown-item py-0"
            href="<?php echo site_url('coaching/users/my_password/' . $coaching_id . '/' . $member_id); ?>">
            <div class="d-flex">
...
?>
  ...
  <main>
    ...
    <div class="container-fluid">
      <div class="row <?php if (isset($right_sidebar)) {
    echo 'app-row';
}
?>">
        <div class="col-12">
...
?>
            ...
            <div class="top-right-button-container">
              ...
              <div class="btn-group">
                <button type="button" class="btn btn-primary btn-lg top-right-button " data-toggle="modal"
                  data-backdrop="static" data-target="#exampleModalRight">ACTIONS
                </button>
